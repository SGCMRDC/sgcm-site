      ...
      <header style={{
        ...
        <div className="px-4 md:px-8 lg:px-12" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <a href="/careers" style={{ fontSize: '12px', letterSpacing: '0.07em', color: 'white', textDecoration: 'none', padding: '0 4px', fontWeight: 600 }}>EN</a>
          </div>
      ...
      {menuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex flex-col" style={{ background: 'rgba(8,8,8,0.98)', paddingTop: '102px' }}>
          ...
          <div className="flex items-center justify-center gap-6 mt-auto mb-12">
            <a href="/fr/careers" style={{ color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontSize: '12px', letterSpacing: '0.1em' }}>FR</a>
            <span style={{ color: 'rgba(255,255,255,0.2)' }}>|</span>
            <a href="/careers" style={{ color: 'white', textDecoration: 'none', fontSize: '12px', letterSpacing: '0.1em', fontWeight: 600 }}>EN</a>
          </div>
        </div>
      )}
