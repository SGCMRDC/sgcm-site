...
export const metadata = {
  title: "L'origine responsable, nouvelle condition d'accès aux marchés | SGCM",
  description: "Pourquoi la preuve d'origine responsable est devenue une condition d'acces aux marches.",
};
...
export default function Page() {
  return (
    <ArticleLayout
      ...
      sections={[
        { heading: `Un basculement réglementaire`, paragraphs: [
        ...
        { heading: `La pression de l'aval`, paragraphs: [
        ...
        { heading: `Un marché fondé sur les standards`, paragraphs: [
        ...
        { heading: `La preuve d'origine, pièce maîtresse`, paragraphs: [
        ...
        { heading: `De l'allégation à la preuve`, paragraphs: [
        ...
        { heading: `Une prime aujourd'hui, une norme demain`, paragraphs: [
        ...
        { heading: `Ce que cela change pour la production congolaise`, paragraphs: [
        ...
        { heading: `La preuve comme avantage`, paragraphs: [
