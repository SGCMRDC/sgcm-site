...
export const metadata = {
  title: "Les standards internationaux de devoir de diligence | SGCM",
  description: "L'architecture des standards de devoir de diligence qui conditionne l'acces aux marches.",
};
...
export default function Page() {
  return (
    <ArticleLayout
      ...
      sections={[
        { heading: `Le socle, le Guide OCDE et ses cinq étapes`, paragraphs: [
        ...
        { heading: `La traduction réglementaire, le Règlement UE 2017/821`, paragraphs: [
        ...
        { heading: `Une nouvelle génération de textes, le Critical Raw Materials Act`, paragraphs: [
        ...
        { heading: `L'exigence des raffineurs, la LBMA Responsible Gold Guidance`, paragraphs: [
        ...
        { heading: `La dimension régionale, le mécanisme de la CIRGL`, paragraphs: [
        ...
        { heading: `Les standards, colonne vertébrale de la crédibilité`, paragraphs: [
        ...
        { heading: `Une convergence vers la preuve`, paragraphs: [
      ...
      related={[
        { label: `De l'informel au formel`, href: `/fr/programme-crp/de-l-informel-au-formel` },
