...
export default function Page() {
  return (
    <ArticleLayout
      ...
      intro={`L'exploitation minière artisanale n'est pas un phénomène marginal en République Démocratique du Congo. Elle constitue l'un des piliers de l'économie réelle du pays. Selon la Banque mondiale, l'activité fait vivre environ dix millions de personnes en RDC et représente 10 à 20 % de la production minière nationale. Elle est le deuxième secteur d'emploi du pays après l'agriculture. Comprendre cette économie, c'est comprendre les conditions de vie de millions de foyers et les enjeux de toute une filière placée sous une observation internationale croissante.`}
      sections={[
