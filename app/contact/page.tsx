    ...
    <main className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 py-10 md:py-12 border-b border-gray-200">
            ...
            <div className="md:pl-12">
              ...
              {[
                ...
                { label: 'Verification Portal', href: 'https://sogecom-mining.com/verify' },
              ].map((item) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 py-12 md:py-14 border-b border-gray-200">
          {[
            { title: 'Communications & Partnerships', desc: 'For press inquiries, institutional communication, or partnership proposals, please reach out directly to our communications team.', email: 'contact@sogecom-mining.com' },
            ...
            { title: 'Compliance & Documentation', desc: 'For mandate verification, KYC documentation requests, or SGCM Certified™ inquiries, use our dedicated verification channel.', email: 'verify@sogecom-mining.com' },
          ].map((dept, i) => (
